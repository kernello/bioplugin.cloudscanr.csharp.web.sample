<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Verify.aspx.cs" Inherits="Bioplugin.Cloudscanr.Csharp.Web.Sample.Verify" %>
    ...
    <script type="text/javascript">
        ...
        function captureBiometric() {
            ...
            FingerPrintCapture(deviceName, quickScan, templateFormat, captureType, EnumCaptureMode.TemplateOnly, EnumBiometricImageFormat.WSQ,
                    EnumSingleCaptureMode.LeftFingerCapture, 300.0, EnumCaptureOperationName.VERIFY, CaptureResult);
         }
